...
int main(int argc, char *argv[])
{
    ...
    for (int i = 0; i < N; i++)
    {
        ...
        upcxx::broadcast(vec, N - i, 0).wait();
        upcxx::barrier();
        ...
        if (x > 0)
        {
            ...
            p->scatter(myid, mat, displs[myid],  tmpN * (N - i));
            upcxx::barrier();
            ...
            mat->gather(myid, matTmp, displs[myid], send_counts[myid]);
            upcxx::barrier();
            ...
            mat->gather(myid, matTmp, displs2[myid], send_counts2[myid]);
            upcxx::barrier();
